package com.exemplo.algamoney.api.storage;
...
public class S3 {
	...
	public String salvarTeporariamente(MultipartFile arquivo) {
		...
		String nomeUnico = gerarNomeArquivo(arquivo.getOriginalFilename());
	...
	private String gerarNomeArquivo(String originalFilename) {
